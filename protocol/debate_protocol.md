...
## Mở rộng tùy chọn
- `EXTRA ROUND [chủ đề]`: người dùng có thể yêu cầu thêm một cặp phản biện về một chủ đề hẹp (vd: chỉ về Bản ghi nhớ Budapest). Vòng này được chấm như vòng phản biện (xem "Quy tắc áp dụng theo vòng" trong rubric). **Cách vòng E vào tổng điểm theo mục "Vòng E và tổng điểm" bên dưới (P1, 14/07/2026): điểm chính thức = V1–V5; vòng E chỉ vào phán quyết chính thức khi chủ đề đối xứng + qua `APPROVE TRANSCRIPT ADDENDUM`.**
